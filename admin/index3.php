...
<?php
    ...
    include_once('../app/mostrar_pedidos.php');
?>
<html lang="en">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                <h2 class="number"><?php echo "$Nfavorito"; ?></h2>
                                <span class="desc">Produto favorito</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--red">
                                <h2 class="number">kz <?php echo "$TotalVendido";?></h2>
                                <span class="desc">total arrecadado</span>
                                <div class="icon">
            ...
            <section class="p-t-20">
                <div class="container">
                    <div class="row">
                        ...
                        <h3 class="title-5 m-b-35">Dados de pedidos feitos</h3>
                                ...
                                <table class="table table-data2">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            <td class='desc'>".$data['telefone']."</td>
                                            <td>".$data['cidade']."</td>
                                            <td>".$data['produtos']."</td>
                                            <td>".$data['preco']."</td>
                                            <td>".$data['qtd']."</td>
